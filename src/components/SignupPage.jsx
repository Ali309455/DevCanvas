...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-[70vh] px-4 py-12">
      <div className="w-full max-w-[450px] max-sm:max-w-[350px] flex flex-col gap-[32px] py-12 px-8 border-2 border-border bg-surface rounded-[var(--radius-card)] shadow-brutal dark:shadow-brutal-accent">
        <div className="flex justify-center border-b border-border dark:border-neutral-800 pb-6">
          <Logo />
        </div>

        <div className="flex flex-col gap-2 text-center">
          <h2 className="text-[28px] font-bold font-heading text-primary-text uppercase tracking-tight">Create Identity</h2>
          <p className="text-[14px] text-secondary-text font-mono">
            <span className="text-primary-accent">/</span> Already known?&nbsp;
            <Link
              to="/login"
        ...
        <form onSubmit={handleSubmit(registerUser)} className="mt-2">
